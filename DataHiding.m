...
% DATAHIDING MATLAB code for DataHiding.fig
%      DATAHIDING, by itself, creates a new DATAHIDING or raises the existing
%      singleton*.
%
%      H = DATAHIDING returns the handle to a new DATAHIDING or the handle to
%      the existing singleton*.
%
%      DATAHIDING('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DATAHIDING.M with the given input arguments.
%
%      DATAHIDING('Property','Value',...) creates a new DATAHIDING or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DataHiding_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DataHiding_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DataHiding

% Last Modified by GUIDE v2.5 13-May-2017 08:29:26
...
helpdlg('Data telah sukses disimpan di dalam file secret.bmp');
