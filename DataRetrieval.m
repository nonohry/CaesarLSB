...
% DATARETRIEVAL MATLAB code for DataRetrieval.fig
%      DATARETRIEVAL, by itself, creates a new DATARETRIEVAL or raises the existing
%      singleton*.
%
%      H = DATARETRIEVAL returns the handle to a new DATARETRIEVAL or the handle to
%      the existing singleton*.
%
%      DATARETRIEVAL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DATARETRIEVAL.M with the given input arguments.
%
%      DATARETRIEVAL('Property','Value',...) creates a new DATARETRIEVAL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DataRetrieval_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DataRetrieval_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DataRetrieval

% Last Modified by GUIDE v2.5 13-May-2017 08:29:11
